...
def Conv2D(num_classes, sample_rate, duration):
    ...
    hidden = LogmelToMFCC(data_format='channels_last')(input.output)
    hidden = tf.keras.layers.LayerNormalization(axis=2, name='layer_norm_1')(hidden)
    ...
    hidden = tf.keras.layers.Conv2D(32, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_3')(hidden)
    hidden = tf.keras.layers.Conv2D(32, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_4')(hidden)
    hidden = tf.keras.layers.MaxPooling2D(pool_size=(2,2), padding='same', name='max_pool_2d_4')(hidden)
    hidden = tf.keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_5')(hidden)
    hidden = tf.keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_6')(hidden)
    hidden = tf.keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_7')(hidden)
    hidden = tf.keras.layers.MaxPooling2D(pool_size=(2,2), padding='same', name='max_pool_2d_6')(hidden)
    hidden = tf.keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_8')(hidden)
    hidden = tf.keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_9')(hidden)
    hidden = tf.keras.layers.Conv2D(64, kernel_size=(3,3), activation='relu', padding='same', name='conv2d_relu_10')(hidden)
    hidden = tf.keras.layers.MaxPooling2D(pool_size=(2,2), padding='same', name='max_pool_2d_7')(hidden)
    hidden = tf.keras.layers.MaxPooling2D(pool_size=(2,2), padding='same', name='max_pool_2d_8')(hidden)
    hidden = tf.keras.layers.Flatten(name='flatten')(hidden)
    hidden = tf.keras.layers.Dropout(rate=0.5, name='dropout_2')(hidden)
    hidden = tf.keras.layers.Dense(512, name='dense_1', activity_regularizer=tf.keras.regularizers.l2(0.001))(hidden)
